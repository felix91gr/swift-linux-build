// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 1)
...
// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 19)
...
// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 168)
...
// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 258)
  ...
  public subscript(bounds: Range<Index>) -> Slice<LazyFilterCollection<Base>> {
...
///   general operations on `LazyFilterCollection` instances may not have the
///   documented complexity.
public struct LazyFilterBidirectionalCollection<
...
// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 242)
...
// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 258)
  ...
  public subscript(bounds: Range<Index>) -> BidirectionalSlice<LazyFilterBidirectionalCollection<Base>> {
    return BidirectionalSlice(base: self, bounds: bounds)
  }

  // FIXME(ABI)#28 (Associated Types with where clauses): we actually want to add:
  //
  //   typealias SubSequence = LazyFilterBidirectionalCollection<Base.SubSequence>
  //
  // so that all slicing optimizations of the base collection can kick in.
  //
  // We can't do that right now though, because that would force a lot of
...
// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 294)
...
// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 311)
  ...
  Elements : BidirectionalCollection
{
  ...
  public func filter(
    _ isIncluded: @escaping (Elements.Iterator.Element) -> Bool
  ) -> LazyFilterBidirectionalCollection<Self.Elements> {
    return LazyFilterBidirectionalCollection(
      _base: self.elements, isIncluded)
  }
}

// ###sourceLocation(file: "/home/felix/Desktop/NativeSetup/swift-linuxSetup/native_install/swift/stdlib/public/core/Filter.swift.gyb", line: 332)
